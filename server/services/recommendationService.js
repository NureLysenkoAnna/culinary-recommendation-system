    ...
    switch (diet) {
      ...
      case 'vegan':
        query.ingredients = { $nin: ['яловичина', 'свинина', 'курка', 'індичка', 'риба',
          'птиця', 'яйця', 'молоко', 'сир', 'йогурт', 'мед', 'желатин', 'вершкове масло', 'кефір',
      ...
      case 'gluten-free':
        ...
        break;
      case 'dairy-free':
        query.ingredients = { $nin: ['молоко', 'сир', 'йогурт', 'вершкове масло', 'вершки', 'сухе молоко',
      ...
      case 'low-carb':
        ...
        break;
      case 'low-fat':
        query.ingredients = { $nin: ['вершкове масло', 'свинина', 'баранина', 'сир', 'ковбаса', 'майонез', 
